...
**Audience:** Anyone navigating this repo. **Last verified:** 2026-09-25 · **Gate:** `ls docs/ && markdown-link-check docs/*.md`
...
| `FEATURES.md` | Every capability + how it works | ✅ **Current** — verified 2026-09-25 |
| `TUNING.md` | Every config key: default, range, trade-off, when to change | ✅ **Current** — verified 2026-09-25 |
...
| File | Purpose | Freshness |
|---|---|---|
| `README.md` | Front door — what, why, quick start, CLI, IPC, config, performance | ✅ **Current** — verified 2026-09-25 |
...
| `CHANGELOG.md` | Release history | ✅ **Current** — exists |
